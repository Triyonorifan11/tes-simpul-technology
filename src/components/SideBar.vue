...
<template>
    <div class="bg-primary">
                <span class="lg:hidden block absolute text-white text-4xl top-1 right-1 cursor-pointer z-50" @click="openSidebar()">
                    <i class="bi bi-filter-left px-1 bg-gray-900 rounded-md"></i>
                </span>
                <div class="hidden lg:block sidebar min-h-screen fixed lg:sticky top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-900 z-50">
                    ...
                    <div class="p-2.5 flex lg:hidden items-center rounded-md px-4 duration-300 cursor-pointer bg-gray-700 text-white ">
